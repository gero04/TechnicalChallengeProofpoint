class ReportGenerator:
    ...
    def generateReport(self, totalInput, totalOutput, discarded, corrected, duplicates):
        # Here we are going to assemble the MarkDown report
        content = f"""
# Data Quality Report
## Technical Challenge Intern Program - Proofpoint - March 2026
### Records statistics
- **Total input records:** {totalInput}
- **Total output records:** {totalOutput}
- **Discarded records:** {discarded}
- **Corrected records:** {corrected}
- **Duplicated records:** {duplicates}
